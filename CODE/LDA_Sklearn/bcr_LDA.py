...
class BCR_LDA:
    ...
    def get_dataset(self, filename, category):

        lda_df = pd.read_csv(filename)
        reviews_df = pd.read_csv('../pet_reviews_all.csv')
...
if __name__ == '__main__':
    final = None
    sLDA = BCR_LDA()
    categories, category_ids, asin_count = sLDA.get_categories('category.csv')
    ...
    for category in categories:
        ...
        dataset = sLDA.get_dataset('category.csv', category)
